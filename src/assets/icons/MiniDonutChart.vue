<template>
  ...
  >
    ...
    <path
      ...
      style="fill: #4caf50; stroke: #202020; stroke-width: 66.67px"
    />
    <!-- Red segment -->
    <path
      ...
      style="fill: #ef5350; stroke: #202020; stroke-width: 66.67px"
    />
    <!-- Purple segment -->
    <path
      ...
      style="fill: #7c4dff; stroke: #202020; stroke-width: 66.67px"
    />
  </svg>
</template>
