        ...
        >
          ...
          >
            ...
            <div class="flex items-center gap-2 mb-6">
              ...
              <span class="text-xs text-text-primary bg-bg-surface px-2 py-0.5 rounded">{{ slide.iban }}</span>
              <span class="text-xs text-text-secondary">***</span>
            </div>
            
            <!-- Actions -->
            <div class="flex gap-3">
              <button class="flex-1 flex items-center justify-between px-4 bg-bg-surface rounded-xl py-3 hover:bg-bg-surface/80 transition-colors">
          ...
          >
            <div class="flex items-center justify-between mb-2">
              ...
              <button class="w-10 h-6 bg-bg-surface rounded-full flex items-center justify-end pr-1">
          ...
          >
            <div class="flex items-start justify-between">
              <div class="flex-1">
                ...
                <h3 class="text-2xl font-bold text-text-primary leading-tight whitespace-pre-line mb-1">{{ slide.title }}</h3>
                
                <p class="text-sm text-text-secondary">{{ slide.subtitle }}</p>
              </div>

              <div class="w-32 h-32 shrink-0">
                <img :src="slide.logo" alt="Kıymetli Madenler" class="w-full h-full object-contain" />
              </div>
            </div>

            <button class="absolute bottom-5 left-5 right-5 flex items-center justify-between bg-bg-card/90 backdrop-blur rounded-xl px-4 py-3.5 hover:bg-bg-card transition-colors">
          ...
          >
            <div class="flex items-start justify-between">
              <div class="flex-1">
                <div v-if="slide.icon" class="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center mb-3 text-2xl">
                  {{ slide.icon }}
                </div>
