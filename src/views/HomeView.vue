...
import { Send, ArrowLeftRight, Globe, ShieldCheck, RefreshCw, QrCode, Smartphone, Banknote } from 'lucide-vue-next'
...
<template>
  <div class="flex-1 overflow-y-auto">
    ...
    <div class="px-4 mb-4">
      <SectionHeader 
        title="DAHA İYİ BİR PAPARA DENEYİMİ"
        pagination="2 / 5"
      />
    </div>
